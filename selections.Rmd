...
ayt20_sindex <- read_csv("tables/AYT20_SINDEX.csv") %>%
  janitor::clean_names() %>% 
...
```{r out.width="100%", echo=FALSE, message=FALSE, include=FALSE}
